...
Soil sample is at waypoint1. 
Soil sample is at waypoint3. 
Soil sample is at waypoint2. 
Soil sample is at waypoint0. 
Rover rover0 is at waypoint2. 
Rover rover1 is at waypoint4. 
...
Rover rover0 is equipped for soil analysis. 
Rover rover1 is equipped for imaging. 
Rover rover0 can traverse from waypoint2 to waypoint3. 
Rover rover0 can traverse from waypoint2 to waypoint0. 
Rover rover1 can traverse from waypoint4 to waypoint3. 
Rover rover0 can traverse from waypoint3 to waypoint2. 
...
Rover rover1 can traverse from waypoint3 to waypoint4. 
Rover rover1 can traverse from waypoint4 to waypoint0. 
Rover rover1 can traverse from waypoint0 to waypoint4. 
...
Camera camera1's calibration target is objective objective1. 
Camera camera0 is on board with rover rover0. 
Camera camera2 supports low_res. 
...
Objective objective0 is visible from waypoint0. 

Your goal is the following: 
Communicated soil data should be at waypoint3. 
Communicated rock data should be at waypoint0. 
Communicated rock data should be at waypoint4. 
Communicated image data should be at objective0 with low_res resolution. 
Communicated image data should be at objective1 with colour resolution. 

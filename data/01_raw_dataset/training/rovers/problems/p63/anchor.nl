You have 3 cameras, 2 rovers, 5 waypoints, and 2 objectives. 
...
Soil sample is at waypoint4. 
The general is at the lander at waypoint2. 
Rock sample is at waypoint3. 
Rock sample is at waypoint2. 
Rock sample is at waypoint0. 
Rover rover1 is at waypoint1. 
Rover rover0 is at waypoint0. 
...
Rover rover1 is equipped for rock analysis. 
Rover rover1 is equipped for soil analysis. 
Rover rover0 is equipped for rock analysis. 
Rover rover1 is equipped for imaging. 
Rover rover1 can traverse from waypoint1 to waypoint3. 
...
Rover rover0 can traverse from waypoint2 to waypoint0. 
Rover rover0 can traverse from waypoint0 to waypoint1. 
Rover rover1 can traverse from waypoint1 to waypoint0. 
Rover rover1 can traverse from waypoint1 to waypoint4. 
Rover rover0 can traverse from waypoint3 to waypoint1. 
Rover rover1 can traverse from waypoint3 to waypoint1. 
Rover rover0 can traverse from waypoint0 to waypoint2. 
Rover rover1 can traverse from waypoint0 to waypoint1. 
Rover rover1 can traverse from waypoint4 to waypoint1. 
Rover rover0 can traverse from waypoint4 to waypoint0. 
Rover rover0 can traverse from waypoint0 to waypoint4. 
Rover rover0 can traverse from waypoint1 to waypoint3. 
Camera camera0 supports high_res. 
Camera camera2's calibration target is objective objective0. 
Camera camera2 is on board with rover rover1. 
Camera camera2 supports high_res. 
Camera camera0 supports low_res. 
Camera camera1's calibration target is objective objective0. 
Camera camera0 is on board with rover rover0. 
Camera camera1 supports high_res. 
Camera camera1 is on board with rover rover0. 
Camera camera0 supports colour. 
Camera camera2 supports colour. 
Camera camera0's calibration target is objective objective0. 
Objective objective1 is visible from waypoint1. 
Objective objective0 is visible from waypoint1. 
Objective objective0 is visible from waypoint3. 
Objective objective1 is visible from waypoint2. 
Objective objective1 is visible from waypoint4. 

Your goal is the following: 
Communicated soil data should be at waypoint4. 
Communicated rock data should be at waypoint0. 
Communicated rock data should be at waypoint2. 
Communicated image data should be at objective1 with high_res resolution. 
Communicated image data should be at objective0 with high_res resolution. 

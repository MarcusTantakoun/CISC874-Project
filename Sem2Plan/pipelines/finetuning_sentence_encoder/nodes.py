...
from pipelines.setup_sentence_encoder.nodes import create_sentence_encoder_helper
...
def train_sentence_encoder(setup_sentence_encoder_cfg, finetuning_encoder_cfg, cosine_sim_comparison_data):
    ...
    # 1. Define SentenceTransformer model - if not already a Sentence Transformer model, it will auto create one with "mean" pooling
    if not is_finetune_complete:
        ...
        # guide model: https://sbert.net/docs/package_reference/sentence_transformer/losses.html#gistembedloss
        ...
        # 6. Save trained and evaluated model locally
    ...
    # 7. Evaluate model performance on STS Benchmark test dataset
...
def generate_testing_domains_eval_df(finetuned_model):
    def local_comparing_setting_helper(
        ...
        # update dataframe and return updated dataframe
